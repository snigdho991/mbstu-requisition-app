                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <p style="text-align: center;">@if(Auth::user()->signature) Current @else Default @endif Signature</p>
                                        <div class="zoom-gallery d-flex flex-wrap">
                                            @if(Auth::user()->signature)
                                                <a href="{{ asset('assets/uploads/signatures/'.Auth::user()->signature) }}" title="{{ Auth::user()->signature }}">
                                                    <img src="{{ asset('assets/uploads/signatures/'.Auth::user()->signature) }}" alt="" style="height: 125px !important; width: 350px !important;" class="img-thumbnail">
                                                </a>
                                            @else
                                                <a href="{{ asset('assets/uploads/signatures/no-signature.png') }}" title="No Signature">
                                                    <img src="{{ asset('assets/uploads/signatures/no-signature.png') }}" alt="" style="height: 125px !important; width: 350px !important;" class="img-thumbnail">
                                                </a>
                                            @endif
                                        </div>
                                ...
                                <div class="row mb-4">
                                    <label for="validationTooltip101" class="col-lg-2 col-form-label">Change Signature</label>
                                    
                                    <div class="col-lg-10" style="margin-bottom: 0.7rem!important;">
                                        <input type="file" class="form-control" id="validationTooltip101" name="signature">                                        
                                    </div>
                                </div>
