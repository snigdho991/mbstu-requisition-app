...
@section('title', 'Administration - Forwarded Requisitions To Vice Chancellor')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Administration - Forwarded Requisitions To Vice Chancellor (<?php echo $pending->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('administrator.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Forwarded Requisitions</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Administration - Forwarded Requisitions To Vice Chancellor (<?php echo $pending->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#0275d8 !important;">Forwarded To VC</span>
                                                </span>
                                            </td>
                                            <td>{{ $teacher->name }}</td>
