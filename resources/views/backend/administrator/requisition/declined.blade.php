                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administration - Declined Requisitions (<?php echo $declined->count(); ?>)</b></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#f46a6a !important;">Declined By Chair.</span>
                                                </span>
                                            </td>
                                            <td>{{ $teacher->name }}</td>
