...
@section('title', 'Administration - Approved Requisitions')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Administration - Approved Requisitions (<?php echo $approved->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('administrator.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Approved Requisitions(Administration)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administration - Approved Requisitions (<?php echo $approved->count(); ?>)</b></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#34c38f !important;">Approved By Admin</span>
                                                </span>
                                            </td>
                                            <td>{{ $teacher->name }}</td>
