            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Approved Users List (<?php echo $teachers->count(); ?>)</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Approved Users List (<?php echo $teachers->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
