...
@section('title', 'Administration - Declined Requisitions')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Administration - Declined Requisitions (<?php echo $declined->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('teacher.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Declined Requisitions(Administration)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Administration - Declined Requisitions (<?php echo $declined->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#f46a6a !important;">Declined By Admin</span>
                                                </span>
                                            </td>
