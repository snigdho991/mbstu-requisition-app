...
@section('title', 'Create New Requisition - Official')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Create New Requisition - <span class="text-primary">Official</span></h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('teacher.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Create New Requisition - Official</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <input type="hidden" name="requisition_type" value="Official">
                                ...
                                <div class="row" style="background: #f8f8fb!important; margin-top: 10px;">
                                    <div class="col-md-10" style="margin-top: 10px;">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div id="map" style="height: 450px !important; border: 1px solid #bbb !important;" class="gmaps"></div>   
                                        </div>
                                    </div>
